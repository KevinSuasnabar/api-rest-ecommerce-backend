...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET,"/api/available-products").permitAll()
		.antMatchers(HttpMethod.GET,"/api/productos").hasAnyRole("ADMIN")
	...
	/*Cors para soportar clientes diferentes muy importante*/
	@Bean
	public CorsConfigurationSource corsConfigurationSource() {
		...
		source.registerCorsConfiguration("/**", config);//(todos nuestros metodos delback,config)
		return source;
	}
